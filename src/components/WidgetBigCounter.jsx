...
import typography from '@mozaik/ui/lib/theming/typography';
...
const CountText = styled.span`
  ...
  ${props => typography(props.theme, 'display')} font-size: 50vmin;
`;

const Unit = styled.span`
  display: inline-block;
  margin-left: 1vmin;
  ${props => typography(props.theme, 'display')} font-size: 7vmin;
`;
...
const PreLabel = styled.div`
  ...
  text-align: ${props =>
    props.align === 'center'
      ...
      ? 'left'
      : 'right'};
  ${props => typography(props.theme)} font-size: 7vmin;
`;
...
export default class WidgetBigCounter extends Component {
  static propTypes = {
